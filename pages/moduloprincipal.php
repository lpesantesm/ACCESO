...
//$ose_modulo->__set('clave', md5($clave));
//$ose_modulo->__set('ip', $_SERVER['REMOTE_ADDR']);
$reg = $ose_modulo->validaModulousuario(); 
var_dump($reg);
?><!DOCTYPE html>
<html lang="en">
  <head>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt=""><?php echo $_SESSION["nombreusuario"];?>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>MODULOS <small>LISTA DE LOS DIFERENTES MODULOS DEL SISTEMA</small></h2>
